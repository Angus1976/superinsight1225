...
// ============================================================================
// Label Studio API Response Types (from real Label Studio API, uses number IDs)
// ============================================================================

/** Sync status for Label Studio integration */
export type LabelStudioSyncStatus = 'synced' | 'pending' | 'failed';

/** Label Studio project from API (uses number ID) */
export interface LabelStudioApiProject {
  id: number;
  title: string;
  description?: string;
  task_number: number;
  ...
  label_config?: string;
  created_by?: LabelStudioApiUser;
}

/** Label Studio user from API (uses number ID) */
export interface LabelStudioApiUser {
  id: number;
  username: string;
  email?: string;
}

/** Label Studio task from API (uses number ID) */
export interface LabelStudioApiTask {
  id: number;
  data: LabelStudioApiTaskData;
  project: number;
  is_labeled: boolean;
  annotations: LabelStudioApiAnnotation[];
  total_annotations?: number;
}

/** Label Studio task data from API */
export interface LabelStudioApiTaskData {
  text: string;
  [key: string]: unknown;
}

/** Label Studio annotation from API (uses number ID) */
export interface LabelStudioApiAnnotation {
  id: number;
  created_at: string;
  updated_at: string;
  completed_by?: number;
...
export interface SyncCache {
  projects: Map<number, LabelStudioApiProject>;
  projectTasks: Map<number, LabelStudioApiTask[]>;
  lastFetch: number;
}
 ...
 */
export const calculateAnnotationQuality = (tasks: LabelStudioApiTask[]): AnnotationQualityMetrics => {
