...
const RegisterPage: React.FC = () => {
  ...
  // Only redirect after persist has rehydrated (avoid flashing dashboard before localStorage is read)
  if (_hasHydrated && isAuthenticated && token && !isTokenExpired(token)) {
